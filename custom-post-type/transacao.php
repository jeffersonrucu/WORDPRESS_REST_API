<?php
function create_custom_post_type_transacao() {
    /*
     * Os $labels descrevem como o tipo da postagem ira aparecer.
     */
    $labels = array(
        'name'          => 'Transações',  // Plural name
        'singular_name' => 'Transação'    // Singular name
    );
    ...
    $args = array(
        'labels'              => $labels,
        'description'         => 'Adicione nessa postagem todos as transações',                 // Description
        'supports'            => $supports,
    ...
    register_post_type('transacao', $args); //Crie um tipo de postagem com o slug como 'produto' e argumentos em $args.
}

add_action('init', 'create_custom_post_type_transacao');